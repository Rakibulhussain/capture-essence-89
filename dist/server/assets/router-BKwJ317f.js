...
const Route$5 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Bhaskar's Vision showcases professional photography services, featuring portfolios of singers, weddings, and fashion." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Bhaskar's Vision showcases professional photography services, featuring portfolios of singers, weddings, and fashion." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Bhaskar's Vision showcases professional photography services, featuring portfolios of singers, weddings, and fashion." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/ab6e24c2-424b-4309-a3ca-b855efe970c1/id-preview-2b1d719a--1b03d129-c211-4ab6-bb3f-97d31ecb05a9.lovable.app-1777719213433.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/ab6e24c2-424b-4309-a3ca-b855efe970c1/id-preview-2b1d719a--1b03d129-c211-4ab6-bb3f-97d31ecb05a9.lovable.app-1777719213433.png" }
    ],
    links: [
      {
        rel: "stylesheet",
...
const Route$4 = createFileRoute("/work")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Selected photography work by Bhaskar Barman — weddings, fashion editorials, and live music photography."
    }, {
      property: "og:title",
      content: "Work — Bhaskar Barman"
    }, {
...
const Route$3 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Get in touch with Bhaskar Barman for wedding, fashion, or music photography in Assam and beyond."
    }, {
      property: "og:title",
      content: "Contact — Bhaskar Barman"
    }, {
      property: "og:description",
...
const categories = [
  {
    ...
    description: "Over 30+ weddings documented across Assam — candid storytelling blended with creative composition.",
    // ✅ Replace cover image
    cover: "https://ik.imagekit.io/il1hcqwbr/img/IMG_6012.JPG.jpeg?updatedAt=1777720197448",
  ...
  },
  {
    ...
    description: "Styled editorial shoots that highlight personality and brand identity.",
    cover: "https://ik.imagekit.io/il1hcqwbr/img/IMG_8645.JPG.jpeg?updatedAt=1777720197089",
    photos: [
      {
  ...
  },
  {
    ...
    description: "Live performances and music photography capturing raw stage energy.",
    cover: "https://ik.imagekit.io/il1hcqwbr/img/IMG_5334.JPG.jpeg?updatedAt=1777720169707",
    photos: [
      {
...
const heroImage = "https://ik.imagekit.io/il1hcqwbr/img/IMG_6012.JPG.jpeg?updatedAt=1777720197448";
const portraitImage = "https://ik.imagekit.io/il1hcqwbr/img/IMG_8645.JPG.jpeg?updatedAt=1777720197089";
const featured = [
  {
    src: "https://ik.imagekit.io/il1hcqwbr/img/IMG_6012.JPG.jpeg?updatedAt=1777720197448",
    alt: "Featured"
...
const Route$2 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Bhaskar Barman is a professional photographer based in Assam with 4+ years of experience in weddings, fashion and live music photography."
    }, {
      property: "og:title",
      content: "About — Bhaskar Barman"
    }, {
      property: "og:description",
      content: "Photographer based in Assam blending candid storytelling with cinematic composition."
    }, {
      property: "og:image",
...
const Route$1 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Bhaskar Barman — wedding, fashion and live music photographer based in Assam. 4+ years of cinematic, emotion-driven storytelling."
    }, {
      property: "og:title",
      content: "Bhaskar Barman — Cinematic Photographer"
    }, {
      property: "og:description",
  ...
  head: ({
    ...
    return {
      meta: [{
        ...
        property: "og:title",
        content: `${loaderData.title} — Bhaskar Barman`
      }, {
        property: "og:description",
        content: loaderData.description
      }, {
...
const WorkRoute = Route$4.update({
  id: "/work",
  path: "/work",
...
const WorkCategoryRoute = Route2.update({
  id: "/$category",
  path: "/$category",
